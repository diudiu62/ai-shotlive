  ...
  return (
    <div className="min-h-screen bg-[var(--bg-base)] text-[var(--text-secondary)] p-8 md:p-12 font-sans selection:bg-[var(--selection-bg)]">
      <div className="max-w-7xl mx-auto">
        <header className="mb-16 border-b border-[var(--border-subtle)] pb-8 flex items-end justify-between flex-wrap gap-4">
          <div>
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <button
              onClick={logout}
              className="group flex items-center gap-2 px-4 py-3 border border-[var(--border-primary)] text-[var(--text-tertiary)] hover:text-[var(--error-text)] hover:border-[var(--error-border)] transition-colors rounded-md"
              title="退出登录"
            >
            ...
            {onShowOnboarding && (
              <button 
                ...
                className="group flex items-center gap-2 px-4 py-3 border border-[var(--border-primary)] text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:border-[var(--border-secondary)] transition-colors rounded-md"
                title="查看新手引导"
              >
            ...
            <button 
              ...
              disabled={isCreating}
              className="group flex items-center gap-3 px-6 py-3 bg-[var(--btn-primary-bg)] text-[var(--btn-primary-text)] hover:bg-[var(--btn-primary-hover)] transition-colors disabled:opacity-60 disabled:cursor-not-allowed rounded-md"
            >
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div 
              ...
              className={`group flex flex-col items-center justify-center min-h-[300px] transition-all rounded-xl ${
                isCreating 
                  ? 'cursor-not-allowed opacity-60 border border-[var(--border-primary)] bg-[var(--bg-primary)]' 
                  : 'cursor-pointer border border-[var(--border-primary)] hover:border-[var(--border-secondary)] bg-[var(--bg-primary)] hover:shadow-md'
              }`}
            >
              <div className="w-14 h-14 border border-[var(--border-secondary)] flex items-center justify-center mb-6 group-hover:bg-[var(--bg-hover)] transition-colors rounded-full">
                {isCreating ? <Loader2 className="w-6 h-6 text-[var(--text-tertiary)] animate-spin" /> : <Plus className="w-6 h-6 text-[var(--text-tertiary)] group-hover:text-[var(--text-primary)]" />}
              </div>
            ...
            {projects.map((proj) => (
              <div 
                ...
                className="group bg-[var(--bg-primary)] border border-[var(--border-primary)] hover:border-[var(--border-secondary)] p-0 flex flex-col cursor-pointer transition-all relative overflow-hidden h-[300px] rounded-xl hover:shadow-md"
              >
                  {/* Delete Confirmation Overlay */}
                  {deleteConfirmId === proj.id && (
                    <div 
                        className="absolute inset-0 z-20 bg-[var(--bg-primary)] flex flex-col items-center justify-center p-6 space-y-4 animate-in fade-in duration-200 rounded-xl"
                    ...
                    >
                        ...
                        <div className="flex gap-3 w-full pt-2">
                            <button 
                                ...
                                className="flex-1 py-3 bg-[var(--bg-surface)] hover:bg-[var(--bg-hover)] text-[var(--text-tertiary)] hover:text-[var(--text-primary)] text-[10px] font-bold uppercase tracking-wider transition-colors border border-[var(--border-primary)] rounded-md"
                            >
                                取消
                            </button>
                            <button 
                                onClick={(e) => confirmDelete(e, proj.id)}
                                className="flex-1 py-3 bg-[var(--error-hover-bg)] hover:bg-[var(--error-hover-bg-strong)] text-[var(--error-text)] hover:text-[var(--error-text)] text-[10px] font-bold uppercase tracking-wider transition-colors border border-[var(--error-border)] rounded-md"
                            >
                                永久删除
                            </button>
                        </div>
                  ...
                  <div className="flex-1 p-6 relative flex flex-col">
                     ...
                     <button 
                        ...
                        className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 p-2 hover:bg-[var(--bg-hover)] text-[var(--text-muted)] hover:text-[var(--error-text)] transition-all rounded-md z-10"
                        title="删除项目"
                    >
                     ...
                     <div className="flex-1">
                        ...
                        <h3 className="text-sm font-bold text-[var(--text-primary)] mb-3 line-clamp-1 tracking-wide">{proj.title}</h3>
                        <div className="flex flex-wrap gap-2 mb-4">
                            <span className="text-[9px] font-mono text-[var(--text-tertiary)] border border-[var(--border-primary)] px-2 py-1 rounded uppercase tracking-wider">
