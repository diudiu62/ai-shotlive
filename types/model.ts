...
export const BUILTIN_CHAT_MODELS: ChatModelDefinition[] = [
  // ========== OpenAI ==========
  {
    ...
    providerId: "openai",
    description:
      "剧情脚本切分首选：结构化输出稳定，适合分场/分镜、提取人物与事件",
    isBuiltIn: true,
    isEnabled: true,
  ...
  },
  {
    ...
    providerId: "openai",
    description:
      "创意增强型切分：更适合提供多种切分方案、改写节奏与镜头建议（一致性略弱）",
    isBuiltIn: true,
    isEnabled: true,
    params: { ...DEFAULT_CHAT_PARAMS },
  },
  {
    ...
    providerId: "openai",
    description:
      "严谨切分：对复杂叙事与长文本更稳，适合时间线梳理、因果关系与要点校对",
    isBuiltIn: true,
    isEnabled: true,
    params: { ...DEFAULT_CHAT_PARAMS },
  },
  ...
  // 如直接使用 Anthropic 官方 Key，需通过兼容代理或使用 AntSK API。
  {
    ...
    description:
      "长文友好：适合长篇剧本的分段、摘要与角色弧线整理，文字表达更细腻",
    isBuiltIn: true,
    isEnabled: true,
    params: { ...DEFAULT_CHAT_PARAMS },
  },
...
export const BUILTIN_IMAGE_MODELS: ImageModelDefinition[] = [
  ...
  },
  {
    ...
    params: {
      ...
      apiFormat: "openai-image" as ImageApiFormat,
    },
  },
  {
    id: "kling-image-o1",
    ...
    type: "image",
    providerId: "antsk",
    description: "可灵 AI 图片生成模型（通过 AntSK API 代理）",
    isBuiltIn: true,
    isEnabled: true,
    params: {
      ...DEFAULT_IMAGE_PARAMS,
  ...
  // ========== 通义千问 Qwen-Image（DashScope）==========
  {
    ...
    description:
      "阿里通义万相旗舰图片模型，200亿参数 MMDiT 架构，擅长复杂中英文文字渲染",
    isBuiltIn: true,
    isEnabled: true,
    params: {
      ...DEFAULT_IMAGE_PARAMS,
      supportedAspectRatios: ["16:9", "9:16", "1:1"] as AspectRatio[],
      apiFormat: "dashscope-image" as ImageApiFormat,
    },
  },
  {
    id: "qwen-image-plus",
...
export const BUILTIN_VIDEO_MODELS: VideoModelDefinition[] = [
  // ========== Google Veo ==========
  {
    ...
    description: "Veo 3.1 首尾帧模式（通过 AntSK API）",
    isBuiltIn: true,
    isEnabled: true,
  ...
  },
  {
    ...
    providerId: "antsk",
    endpoint: "/v1/videos",
    description: "异步模式，支持横屏/竖屏（通过 AntSK API）",
    isBuiltIn: true,
    isEnabled: true,
  ...
  },
  {
    ...
    endpoint: "/v1/videos",
    description:
      "字节火山引擎最新视频模型，画面质量和动态效果大幅提升，支持有声视频",
    isBuiltIn: true,
    isEnabled: true,
    params: {
      mode: "async" as VideoMode,
  ...
  // ========== 可灵 (Kling) ==========
  {
    ...
    providerId: "antsk",
    endpoint: "/v1/videos",
    description: "可灵 AI 最新视频模型（通过 AntSK API）",
    isBuiltIn: true,
    isEnabled: true,
    params: {
      mode: "async" as VideoMode,
  ...
  // ========== Vidu ==========
  {
    ...
    providerId: "antsk",
    endpoint: "/v1/videos",
    description: "Vidu Q3 Pro 视频生成（通过 AntSK API）",
    isBuiltIn: true,
    isEnabled: true,
    params: {
      mode: "async" as VideoMode,
