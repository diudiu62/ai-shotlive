    ...
    return (
      <div className="h-screen bg-[var(--bg-base)] flex items-center justify-center p-6">
        <div className="max-w-md text-center space-y-6">
          <div className="w-20 h-20 mx-auto mb-4 bg-[var(--bg-primary)] rounded-lg flex items-center justify-center">
            <Clapperboard className="w-10 h-10 text-[var(--accent-text)]" />
          </div>
