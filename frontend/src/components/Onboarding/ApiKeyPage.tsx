...
import { Key, Loader2, CheckCircle, AlertCircle, ChevronDown } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      {selectedProvider?.apiKey ? (
        <div className="text-xs text-green-500 mb-5">
          {selectedProvider.name} API Key 已设置
        </div>
      ) : (
        <div className="text-xs text-red-500 mb-5">
          请设置 {selectedProvider?.name} API Key
        </div>
      )}
